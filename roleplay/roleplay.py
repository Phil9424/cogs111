...
class Roleplay(BaseCog):
    ...
    async def hugs(self, ctx, *, user: discord.Member):
        ...
        # Build Embed
        embed = discord.Embed()
        embed.description = f"**{author.mention} Обнял(а) {user.mention}**"
    ...
    async def cuddle(self, ctx, *, user: discord.Member):
        ...
        # Build Embed
        embed = discord.Embed()
        embed.description = f"**{author.mention} прижался к {user.mention}**"
        embed.set_footer(text="made by Phil Anskulainen")
        embed.set_image(url=images[i])
        await ctx.send(embed=embed)
    ...
    async def kiss(self, ctx, *, user: discord.Member):
        ...
        # Build Embed
        embed = discord.Embed()
        embed.description = f"**{author.mention} поцеловал(а) {user.mention}**"
        embed.set_footer(text="made by Phil Anskulainen")
        embed.set_image(url=images[i])
        await ctx.send(embed=embed)
    ...
    async def slap(self, ctx, *, user: discord.Member):
        ...
        # Build Embed
        embed = discord.Embed()
        embed.description = f"**{author.mention} дал(а) пощечину {user.mention}**"
        embed.set_footer(text="made by Phil Anskulainen")
        embed.set_image(url=images[i])
        await ctx.send(embed=embed)
    ...
    async def pat(self, ctx, *, user: discord.Member):
        ...
        # Build Embed
        embed = discord.Embed()
        embed.description = f"**{author.mention} погладил(а) {user.mention}**"
        embed.set_footer(text="made by Phil Anskulainen")
        embed.set_image(url=images[i])
        await ctx.send(embed=embed)
    ...
    async def lick(self, ctx, *, user: discord.Member):
        ...
        # Build Embed
        embed = discord.Embed()
        embed.description = f"**{author.mention} облизнул(а) {user.mention}**"
        embed.set_footer(text="made by Phil Anskulainen")
        embed.set_image(url=images[i])
        await ctx.send(embed=embed)
    ...
    async def highfive(self, ctx, *, user: discord.Member):
        ...
        # Build Embed
        embed = discord.Embed()
        embed.description = f"**{author.mention} дал(а) пять {user.mention}**"
        embed.set_footer(text="made by Phil Anskulainen")
        embed.set_image(url=images[i])
        await ctx.send(embed=embed)
    ...
    async def feed(self, ctx, *, user: discord.Member):
        ...
        # Build Embed
        embed = discord.Embed()
        embed.description = f"**{author.mention} накормил(а) {user.mention}**"
        embed.set_footer(text="made by Phil Anskulainen")
        embed.set_image(url=images[i])
        await ctx.send(embed=embed)
    ...
    async def tickle(self, ctx, *, user: discord.Member):
        ...
        # Build Embed
        embed = discord.Embed()
        embed.description = f"**{author.mention} защекотал(а) {user.mention}**"
        embed.set_footer(text="made by Phil Anskulainen")
        embed.set_image(url=images[i])
        await ctx.send(embed=embed)
    ...
    async def poke(self, ctx, *, user: discord.Member):
        ...
        # Build Embed
        embed = discord.Embed()
        embed.description = f"**{author.mention} тыкнул(а) {user.mention}**"
        embed.set_footer(text="made by Phil Anskulainen")
        embed.set_image(url=images[i])
        await ctx.send(embed=embed)
    ...
    async def sex(self, ctx, *, user: discord.Member):
        ...
        # Build Embed
        embed = discord.Embed()
        embed.description = f"**{author.mention} занялся сексом с {user.mention}**"
        embed.set_footer(text="made by Phil Anskulainen")
        embed.set_image(url=images[i])
        await ctx.send(embed=embed)
